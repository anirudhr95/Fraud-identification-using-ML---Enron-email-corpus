...
parameters = parameters = dict(feature_selection__k=[11 , 12 ,14 , 16 , 18 , 19 , 20 , 21 ,22 , 'all'],  										                             
...
#      verbose=0))])
#         Accuracy: 0.86733       Precision: 0.50646      Recall: 0.19600 F1: 0.28
# 262     F2: 0.22339
#         Total predictions: 15000        True positives:  392    False positives:
#   382   False negatives: 1608   True negatives: 12618


#PCA
# Pipeline(steps=[('feature_selection', SelectKBest(k=21, score_func=<function f_c
# lassif at 0x000000001679EC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=11, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...ax_iter=1000,
#      multi_class='ovr', penalty='l2', random_state=None, tol=0.0001,
#      verbose=0))])
#         Accuracy: 0.87020       Precision: 0.52810      Recall: 0.24900 F1: 0.33
# 843     F2: 0.27843
#         Total predictions: 15000        True positives:  498    False positives:
#   445   False negatives: 1502   True negatives: 12555
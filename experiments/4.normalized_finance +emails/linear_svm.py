...
parameters = parameters = dict(feature_selection__k=[18 ,  'all'],  				#10 , 15 , 18 , 20 , 22 , 'all'
...
# lassif at 0x0000000016835BA8>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('classifier', LinearSVC(C=1.0, class_weight=None, dual=True, fit_in
# tercept=True,
#      intercept_scaling=1, loss='squared_hinge', max_iter=1000,
#      multi_class='ovr', penalty='l2', random_state=None, tol=0.0001,
#      verbose=0))])
#         Accuracy: 0.81758       Precision: 0.16608      Recall: 0.02350 F1: 0.04
# 117     F2: 0.02837
#         Total predictions: 12000        True positives:   47    False positives:
#   236   False negatives: 1953   True negatives: 9764


#PCA - 
# Pipeline(steps=[('feature_selection', SelectKBest(k=17, score_func=<function f_c
# lassif at 0x000000001675BBA8>)), ('scaler', MinMaxScaler(copy=True, feature_rang
...
#      multi_class='ovr', penalty='l2', random_state=None, tol=0.0001,
#      verbose=0))])
#         Accuracy: 0.84308       Precision: 0.63387      Recall: 0.13850 F1: 0.22
# 733     F2: 0.16416
#         Total predictions: 12000        True positives:  277    False positives:
#   160   False negatives: 1723   True negatives: 9840

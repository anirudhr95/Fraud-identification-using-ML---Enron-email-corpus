...
for x in my_dataset : 
    for features in my_dataset[x] :
            if(features not in finance_features):
...
#newton-cg
# Pipeline(steps=[('feature_selection', SelectKBest(k=5, score_func=<function f_cl
# assif at 0x0000000016722BA8>)), ('scaler', MinMaxScaler(copy=True, feature_range
# =(0, 1))), ('classifier', LogisticRegression(C=1.0, class_weight=None, dual=Fals
# e, fit_intercept=False,
#           intercept_scaling=1, max_iter=100, multi_class='ovr', n_jobs=1,
#           penalty='l2', random_state=None, solver='newton-cg', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.82833       Precision: 0.35849      Recall: 0.03800 F1: 0.06
# 872     F2: 0.04627
#         Total predictions: 12000        True positives:   76    False positives:
#   136   False negatives: 1924   True negatives: 9864

# ExtraTreesClassifier
# Pipeline(steps=[('feature_selection', SelectKBest(k=16, score_func=<function f_c
# lassif at 0x00000000166B8BA8>)), ('scaler', MinMaxScaler(copy=True, feature_rang
...
#            verbose=0, warm_start=False))])
#         Accuracy: 0.80133       Precision: 0.32056      Recall: 0.17150 F1: 0.22
# 345     F2: 0.18908
#         Total predictions: 12000        True positives:  343    False positives:
#   727   False negatives: 1657   True negatives: 9273

#liblinear - without dual :
# Pipeline(steps=[('feature_selection', SelectKBest(k=5, score_func=<function f_cl
# assif at 0x000000001669CBA8>)), ('scaler', MinMaxScaler(copy=True, feature_range
# =(0, 1))), ('classifier', LogisticRegression(C=1.0, class_weight=None, dual=Fals
# e, fit_intercept=True,
#           intercept_scaling=1, max_iter=100, multi_class='ovr', n_jobs=1,
#           penalty='l2', random_state=None, solver='liblinear', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.81942       Precision: 0.10798      Recall: 0.01150 F1: 0.02
# 079     F2: 0.01400
#         Total predictions: 12000        True positives:   23    False positives:
#   190   False negatives: 1977   True negatives: 9810

#liblinear - with dual : 
# Pipeline(steps=[('feature_selection', SelectKBest(k=1, score_func=<function f_cl
# assif at 0x000000001676BBA8>)), ('scaler', MinMaxScaler(copy=True, feature_range
# =(0, 1))), ('classifier', LogisticRegression(C=1.0, class_weight=None, dual=True
# , fit_intercept=True,
#           intercept_scaling=1, max_iter=100, multi_class='ovr', n_jobs=1,
#           penalty='l2', random_state=None, solver='liblinear', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.83225       Precision: 0.11765      Recall: 0.00100 F1: 0.00
# 198     F2: 0.00125
#         Total predictions: 12000        True positives:    2    False positives:
#    15   False negatives: 1998   True negatives: 9985

#PCA
#Extratrees
# Pipeline(steps=[('feature_selection', SelectKBest(k=2, score_func=<function f_cl
# assif at 0x00000000166CDBA8>)), ('scaler', MinMaxScaler(copy=True, feature_range
# =(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=2, random_
# state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier',...timators=10, n_job
# s=1, oob_score=False, random_state=None,
#            verbose=0, warm_start=False))])
#         Accuracy: 0.79458       Precision: 0.30544      Recall: 0.18250 F1: 0.22
# 848     F2: 0.19848
#         Total predictions: 12000        True positives:  365    False positives:
#   830   False negatives: 1635   True negatives: 9170

#Liblinear

# Pipeline(steps=[('feature_selection', SelectKBest(k=17, score_func=<function f_c
# lassif at 0x0000000016823BA8>)), ('scaler', MinMaxScaler(copy=True, feature_rang
...
#           verbose=0, warm_start=False))])
#         Accuracy: 0.84217       Precision: 0.62500      Recall: 0.13250 F1: 0.21
# 865     F2: 0.15729
#         Total predictions: 12000        True positives:  265    False positives:
#   159   False negatives: 1735   True negatives: 9841


#Newton - cg

# Pipeline(steps=[('feature_selection', SelectKBest(k=17, score_func=<function f_c
# lassif at 0x000000001678EBA8>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=10, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...ty='l2', random_stat
# e=None, solver='newton-cg', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.84225       Precision: 0.63342      Recall: 0.12700 F1: 0.21
# 158     F2: 0.15117
#         Total predictions: 12000        True positives:  254    False positives:
#   147   False negatives: 1746   True negatives: 9853
...
# lassif at 0x00000000167C4C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
...
#         Accuracy: 0.84880       Precision: 0.41779      Recall: 0.34050 F1: 0.37
# 521     F2: 0.35358
#         Total predictions: 15000        True positives:  681    False positives:
#   949   False negatives: 1319   True negatives: 12051

# With - PCA
# Pipeline(steps=[('feature_selection', SelectKBest(k=35, score_func=<function f_c
# lassif at 0x0000000016770C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=19, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...e', max_iter=1000, m
# ulti_class='ovr',
#      penalty='l2', random_state=None, tol=0.0001, verbose=0))])
#         Accuracy: 0.87700       Precision: 0.56022      Recall: 0.36050 F1: 0.43
# 870     F2: 0.38818
#         Total predictions: 15000        True positives:  721    False positives:
#   566   False negatives: 1279   True negatives: 12434
...
def normalized_features(x):
    ...
    d.clear()
    for features in x:
        if(features in ['bonus' , 'deferred_income']):
            if(x[features]!='NaN' and x['salary']!='NaN'):
                d['normalized_' + features] = x[features] / float(x['salary'])
            else:
                d['normalized_' + features] = 0.0
    return d
...
parameters = parameters = dict(feature_selection__k= [35,'all'],      #18,20,22,25,26,27,29 , 30 , 31 ,33 , 35,
...
#newton-cg
# Pipeline(steps=[('feature_selection', SelectKBest(k=26, score_func=<function f_c
...
#         Accuracy: 0.86973       Precision: 0.55750      Recall: 0.11150 F1: 0.18
# 583     F2: 0.13274
#         Total predictions: 15000        True positives:  223    False positives:
#   177   False negatives: 1777   True negatives: 12823



#Extratrees - 0.39 -- NO PCA
...
# ne, criterion='gini',
#            max_depth=None, max_features='auto',...stimators=8, n_jobs=1, oob_sco
# re=False, random_state=None,
#            verbose=0, warm_start=False))])
#         Accuracy: 0.86633       Precision: 0.49678      Recall: 0.19300 F1: 0.27
# 800     F2: 0.21989
#         Total predictions: 15000        True positives:  386    False positives:
#   391   False negatives: 1614   True negatives: 12609

# Pipeline(steps=[('feature_selection', SelectKBest(k=10, score_func=<function f_c
# lassif at 0x000000001662FC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('classifier', ExtraTreesClassifier(bootstrap=False, class_weight=No
# ne, criterion='gini',
#            max_depth=None, max_features='auto',...stimators=5, n_jobs=1, oob_sco
# re=False, random_state=None,
#            verbose=0, warm_start=False))])
#         Accuracy: 0.84887       Precision: 0.40205      Recall: 0.27400 F1: 0.32
# 590     F2: 0.29264
#         Total predictions: 15000        True positives:  548    False positives:
#   815   False negatives: 1452   True negatives: 12185

#Liblinear - without dual : 
# Pipeline(steps=[('feature_selection', SelectKBest(k=26, score_func=<function f_c
# lassif at 0x0000000016728C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('classifier', LogisticRegression(C=1.0, class_weight=None, dual=Fal
# se, fit_intercept=True,
#           intercept_scaling=1, max_iter=100, multi_class='ovr', n_jobs=1,
#           penalty='l2', random_state=None, solver='liblinear', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.87600       Precision: 0.61513      Recall: 0.18700 F1: 0.28
# 681     F2: 0.21724
#         Total predictions: 15000        True positives:  374    False positives:
#   234   False negatives: 1626   True negatives: 12766

#liblinear - with dual :
# Pipeline(steps=[('feature_selection', SelectKBest(k=26, score_func=<function f_c
# lassif at 0x0000000016701C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
...
#Extatrees classifier - with PCA
# Pipeline(steps=[('feature_selection', SelectKBest(k=15, score_func=<function f_c
# lassif at 0x000000001679CC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=12, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=False)), ('classifie...timators=15, n_jobs=
# 1, oob_score=False, random_state=None,
#            verbose=0, warm_start=False))])
#         Accuracy: 0.85787       Precision: 0.42517      Recall: 0.18750 F1: 0.26
# 024     F2: 0.21110
#         Total predictions: 15000        True positives:  375    False positives:
#   507   False negatives: 1625   True negatives: 12493

#Liblinear - with dual

# Pipeline(steps=[('feature_selection', SelectKBest(k=24, score_func=<function f_c
# lassif at 0x00000000166C2C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=12, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...ty='l2', random_stat
# e=None, solver='liblinear', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.73147       Precision: 0.31584      Recall: 0.86950 F1: 0.46
# 336     F2: 0.64379
#         Total predictions: 15000        True positives: 1739    False positives:
#  3767   False negatives:  261   True negatives: 9233

#liblinear - without dual

# Pipeline(steps=[('feature_selection', SelectKBest(k=24, score_func=<function f_c
# lassif at 0x0000000016768C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=12, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...ty='l2', random_stat
# e=None, solver='liblinear', tol=0.0001,
...
# lassif at 0x00000000166AAC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=10, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...ty='l2', random_stat
# e=None, solver='newton-cg', tol=0.0001,
#           verbose=0, warm_start=False))])
#         Accuracy: 0.73013       Precision: 0.31395      Recall: 0.86400 F1: 0.46
# 055     F2: 0.63981
#         Total predictions: 15000        True positives: 1728    False positives:
#  3776   False negatives:  272   True negatives: 9224

#POI - EXTRARANDOM!

#Pipeline(steps=[('feature_selection', SelectKBest(k=10, score_func=<function f_c
#lassif at 0x0000000016735C18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
#e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=2, random
#_state=42,
# svd_solver='auto', tol=0.0, whiten=True)), ('classifier'...stimators=5, n_jobs
#=1, oob_score=False, random_state=None,
#          verbose=0, warm_start=False))])
#        Accuracy: 0.83547       Precision: 0.34805      Recall: 0.26800 F1: 0.30
#282     F2: 0.28092
#       Total predictions: 15000        True positives:  536    False positives:
# 1004   False negatives: 1464   True negatives: 11996

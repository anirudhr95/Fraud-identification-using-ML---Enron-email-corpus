...
parameters = parameters = dict(feature_selection__k= [35 , 'all'],          #10 , 15 , 18 , 20 , 22 , 'all'
...
# lassif at 0x000000001670AC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('classifier', LinearSVC(C=1.0, class_weight=None, dual=True, fit_in
# tercept=True,
#      intercept_scaling=1, loss='squared_hinge', max_iter=1000,
#      multi_class='ovr', penalty='l2', random_state=None, tol=0.0001,
#      verbose=0))])
#         Accuracy: 0.86147       Precision: 0.44800      Recall: 0.16800 F1: 0.24
# 436     F2: 0.19200
#         Total predictions: 15000        True positives:  336    False positives:
#   414   False negatives: 1664   True negatives: 12586


#With - PCA
# Pipeline(steps=[('feature_selection', SelectKBest(k=17, score_func=<function f_c
# lassif at 0x000000001676BC18>)), ('scaler', MinMaxScaler(copy=True, feature_rang
# e=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=16, rando
# m_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classifier...0,
#      multi_class='crammer_singer', penalty='l2', random_state=None,
#      tol=0.0001, verbose=0))])
#         Accuracy: 0.86447       Precision: 0.47526      Recall: 0.15850 F1: 0.23
# 772     F2: 0.18288
#         Total predictions: 15000        True positives:  317    False positives:
#   350   False negatives: 1683   True negatives: 12650
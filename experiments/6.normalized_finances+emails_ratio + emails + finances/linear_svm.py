...
parameters = parameters = dict(feature_selection__k=[31, 'all'], 
...
# f_classif at 0x00000000167E4BA8>)), ('scaler', MinMaxScaler(copy=True, feature_r
# ange=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=18, ra
# ndom_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classif...ge', max_iter=500, mult
# i_class='ovr',
#      penalty='l2', random_state=None, tol=0.0001, verbose=0))])
#         Accuracy: 0.73175       Precision: 0.22656      Recall: 0.25250 F1: 0.23
# 883     F2: 0.24685
#         Total predictions: 12000        True positives:  505    False positives:
#  1724   False negatives: 1495   True negatives: 8276

# PCA
# Pipeline(steps=[('feature_selection', SelectKBest(k='all', score_func=<function
# f_classif at 0x0000000016704BA8>)), ('scaler', MinMaxScaler(copy=True, feature_r
# ange=(0, 1))), ('PCA', PCA(copy=True, iterated_power='auto', n_components=18, ra
# ndom_state=42,
#   svd_solver='auto', tol=0.0, whiten=True)), ('classif...ge', max_iter=500, mult
# i_class='ovr',
#      penalty='l2', random_state=None, tol=0.0001, verbose=0))])
#         Accuracy: 0.73358       Precision: 0.23197      Recall: 0.25900 F1: 0.24
# 474     F2: 0.25310
#         Total predictions: 12000        True positives:  518    False positives:
#  1715   False negatives: 1482   True negatives: 8285